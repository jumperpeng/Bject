...
<a href="{{ route('admin.accountadmin.index')}}" class="btn btn-primary mt-3 pt-2">Back</a>
<a href="/accountadmin/{{$admins->id}}/edit" class="btn mt-3 pt-2"
    style="color:black; background-color:rgb(236, 175, 60);">Edit</a>


<form action="{{ action('App\Http\Controllers\Admin\AdminController@destroy',$admins->id ) }}" method="POST" class="mt-2 text-center">
